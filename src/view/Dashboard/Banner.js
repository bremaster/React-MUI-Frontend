    ...
    <>
    	<Grid container sx={{flexDirection: {md: "column-reverse", xl: "row"}, mt: {md: '73px', xs: '0'} }}>
          ...
          <Box sx={{px: {md: '95px', xs: '48px'} }}>
  		  ...
  		  <Grid container item md={12} xl={6} justifyContent="center" alignItems="center" sx={{px: {md: "135px", xs: '25px'}, pt: {md: "0", xs: '25px'} }}>
          <Box>
            <Box
              component="img"
              src="/assets/Design/VideoSample.png"
        ...
        <Grid item md={12} xl={6}>
          <Stack alignItems="end" justifyContent="center" sx={{height: '195px', display: {xs: 'none', xl: 'flex'} }}>
            <Box
              component="img"
